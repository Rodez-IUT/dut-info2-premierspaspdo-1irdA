...
<body>
    ...
    <form method="post" action="all_users4.php">
    	...
    	<select name="statusID", id="statusID">
            ...
            <option htmlspecialchars>Waiting for account deletion</option>
    	</select>
    ...
    <?php 
        ...
        if (isset($_POST["statusID"]) && $_POST["statusID"] == "Waiting for account validation") {
        	$statusID = 1;
        } else if (isset($_POST["statusID"]) && $_POST["statusID"] == "Waiting for account deletion") {
            $statusID = 3;
        }
